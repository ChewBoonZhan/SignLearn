...
public class AttachmentsTest extends TestCase {
    ...
    private void init_translator_can_verify_id(){
        ...
        translator_can_verify_id.add(R.id.like_id);
        translator_can_verify_id.add(R.id.dislike_id);
        translator_can_verify_id.add(R.id.iloveyou_id);
    ...
    private void init_translator_cannot_verify_id(){
        ...
        translator_cannot_verify_id.add(R.id.adore_id);

    }
    private void init_translator_can_verify_notifi(){
        translator_can_verify_notifi = new ArrayList<Integer>();
        translator_can_verify_notifi.add(R.id.like_notifi);
        translator_can_verify_notifi.add(R.id.dislike_notifi);
        translator_can_verify_notifi.add(R.id.iloveyou_notifi);

    }
    private void init_translator_cannot_verify_notifi(){
        translator_cannot_verify_notifi = new ArrayList<Integer>();
        translator_cannot_verify_notifi.add(R.id.adore_notifi);
    }
    private void init_lesson_topics(){
        lesson_title = new ArrayList<Integer>();
        lesson_title.add(R.string.like_title);
        lesson_title.add(R.string.dislike_title);
        lesson_title.add(R.string.iloveyou_title);
        lesson_title.add(R.string.adore_title);

    }private void init_lesson_description(){
        lesson_description = new ArrayList<Integer>();
        lesson_description.add(R.string.like_content);
        lesson_description.add(R.string.dislike_content);
        lesson_description.add(R.string.iloveyou_content);
        lesson_description.add(R.string.adore_content);
    ...
    public void set_category_syllabus_unlocked(){
        // lock category , by default
        file_connections.lock_category(categories[category_index]);
