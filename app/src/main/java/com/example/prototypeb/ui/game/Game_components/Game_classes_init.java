...
public class Game_classes_init {
    private HashMap <Integer,Game_components> game_classes;
    App_data app_data;
    ...
    private void init_game_classes(){
        game_classes = new HashMap<Integer,Game_components>();
    ...
    public HashMap<Integer,Game_components> getGame_classes(){
        return game_classes;
    }
}
